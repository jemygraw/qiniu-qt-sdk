...
QString QNMac::sign(const QByteArray *data)
{
...
// step1 with ':'
QString QNMac::signWithData(const QByteArray *data)
{
...
QString QNMac::signRequest(const QNetworkRequest *request,const QByteArray *bodyData=NULL)
{
